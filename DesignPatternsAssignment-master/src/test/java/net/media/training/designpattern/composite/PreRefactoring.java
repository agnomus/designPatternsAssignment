...
public class PreRefactoring {
    ...
    public void BasicStuffWorks() {
        ...
        assertTrue("File file1 should exist.", src.fileSystemElementExists("file1"));
        assertTrue("Directory data should exist.", src.fileSystemElementExists("data"));
        assertTrue("Directory src should exist.", src.fileSystemElementExists("src"));

        dataDir.delete();

        assertFalse("File file1 should not exist.", src.fileSystemElementExists("file1"));
        assertFalse("Directory data should not exist.", src.fileSystemElementExists("data"));
    }
}
